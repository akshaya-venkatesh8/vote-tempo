  ...
  return (
    <div className={styles.container}>
      ...
      <footer className={styles.footer}>
        <a
          href="https://www.instagram.com/goumo_dancechronicles/"
          target="_blank"
          rel="noopener noreferrer"
          className={styles.instaLink}
        >
          <svg className={styles.instaIcon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
